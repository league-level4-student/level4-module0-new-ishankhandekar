...
public class Snake {
    ...
    private boolean isOppositeDirection(Direction direction) {
    	...
    	if (currentDirection == currentDirection.RIGHT && direction == currentDirection.LEFT) {
			isOpposite = true;
		}
    	else if (currentDirection == currentDirection.UP && direction == currentDirection.DOWN) {
			isOpposite = true;
		}
    	else if (currentDirection == currentDirection.LEFT && direction == currentDirection.RIGHT) {
			isOpposite = true;
		}
    	else if (currentDirection == currentDirection.DOWN && direction == currentDirection.UP) {
			isOpposite = true;
		}
    ...
    public boolean isOutOfBounds() {
         ...
         */
    	System.out.println(snake.get(0).getLocation().getX() + " " + snake.get(0).getLocation().getY());
    	if (snake.get(0).getLocation().getY() > SnakeGame.HEIGHT || snake.get(0).getLocation().getY() < 0 ||
    			snake.get(0).getLocation().getX() > SnakeGame.WIDTH || snake.get(0).getLocation().getX() < 0) {
			return true;
		}
